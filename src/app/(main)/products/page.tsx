...
export default function ProductsPage() {
  return (
    <main className="flex min-h-screen flex-col items-center px-5 pt-10.5 pb-16 md:px-20">
      <div className="w-full">
        {' '}
        <div className="mb-4 flex items-center font-['Geom'] text-sm text-gray-500 md:text-base">
          <span>Product List</span>
          <span className="mx-2">&gt;</span>
          <span className="text-[#363636]">Nama Produk</span>
        </div>
        <Suspense fallback={<div className="mb-4 h-20 animate-pulse rounded-lg bg-gray-200" />}>
          <SearchFilterPanel />
        </Suspense>
